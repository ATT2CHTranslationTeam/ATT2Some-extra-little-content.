...
tellraw @s[scores={LANGUAGE=2}] {"text":" °-° Intendant Joffrey : ","color":"green","extra":[{"text":"谢谢惠顾！请拿好房子的钥匙。您的新家就在这片街区—出门右转后直走就是。","color":"dark_aqua"}]}
...
#tellraw @s[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":":"},{"text":"[支付3000Chronotons获得房屋钥匙！-->]","color":"green","clickEvent":{"action":"run_command","value":"/function att2:dialogs/dialogs_review/sidequest_dialogs/sq30/adrian1"},"hoverEvent":{"action":"show_text","value":"点击这里—回答1"}}]}
