...
tellraw @s[scores={LANGUAGE=2}] {"text":" °-° Omeryn White : ","color":"green","extra":[{"text":"你这神经病！我要干你！","color":"dark_aqua"}]}
tellraw @s[scores={LANGUAGE=2}] {"text":"你与Omeryn展开了激烈的搏斗，任务失败..","color":"dark_red"}
