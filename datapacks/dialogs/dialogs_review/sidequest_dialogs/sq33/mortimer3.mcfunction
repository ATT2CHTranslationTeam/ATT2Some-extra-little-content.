...
tellraw @s[scores={LANGUAGE=2}] {"text":" °-° Mortimer : ","color":"green","extra":[{"text":"我觉得这样会花光我所有的积蓄...好吧，我已经有机会得到你的帮助了！反正没人愿意帮我。你去探索Sylberländ大陆的每个地图，每带回一个石阵样本，我就会给你100个Chronorons。","color":"dark_aqua"}]}
