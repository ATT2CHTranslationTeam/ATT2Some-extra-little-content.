...
tellraw @s[scores={LANGUAGE=2}] {"text":"【利益的诱饵】","color":"dark_green"}

function att2:sound/dialogs/simple
#function att2:sound/misc/fail1
#function att2:sound/misc/combo
tellraw @s[scores={LANGUAGE=2}] {"text":"你在Linda的指引下，找到了这次探险的领队Williams...","color":"dark_green"}
tellraw @s[scores={LANGUAGE=2}] {"text":" °-° Ashley Williams : ","color":"green","extra":[{"text":"是的，你想要什么？","color":"dark_aqua"}]}
