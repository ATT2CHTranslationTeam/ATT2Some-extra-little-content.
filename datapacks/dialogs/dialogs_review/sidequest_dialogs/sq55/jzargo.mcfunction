...
tellraw @s[scores={LANGUAGE=2}] {"text":"【J'zargo的奇妙冒险 - 第 5 部分】","color":"dark_green"}

function att2:sound/dialogs/simple
#function att2:sound/misc/fail1
#function att2:sound/misc/combo
#tellraw @s[scores={LANGUAGE=2}] {"text":" °-° Malak : ","color":"green","extra":[{"text":"","color":"dark_aqua"}]}
tellraw @s[scores={LANGUAGE=2}] {"text":"你在Elcheol山顶的一处神庙门口找到了J'zargo,并帮他找到了一个神秘的纸条...","color":"dark_green"}
