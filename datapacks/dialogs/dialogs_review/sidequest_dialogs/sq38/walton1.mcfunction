...
tellraw @s[scores={LANGUAGE=2}] {"text":" °-° Walton Jones : ","color":"green","extra":[{"text":"*气喘吁吁*呼，还好你没下狠手...我差点以为我要死了。我得继续挖掘这片废墟中的隐藏的秘密。过一段时间再来找我吧，也许到时候我会有一些新发现...","color":"dark_aqua"}]}
#tellraw @s[scores={LANGUAGE=2}] {"text":"任务失败","color":"dark_red"}
tellraw @s[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":":"},{"text":"[-->]","color":"green","clickEvent":{"action":"run_command","value":"/function att2:dialogs/dialogs_review/sidequest_dialogs/sq38/end1"},"hoverEvent":{"action":"show_text","value":"点击这里—回答"}}]}
