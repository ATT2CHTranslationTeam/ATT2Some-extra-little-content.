...
tellraw @s[scores={LANGUAGE=2}] {"text":" °-° Walton Jones : ","color":"green","extra":[{"text":"这真是一场惊心动魄的战斗！太令人印象深刻了。那把恐怖的武器你就留着吧...嗯，这里估计没有我要做的事情了，我要回Soquaï继续挖掘化石了，在你赶跑了那边的怪物之后，我至少不用冒着风险去干活了。","color":"dark_aqua"}]}
#tellraw @s[scores={LANGUAGE=2}] {"text":"任务失败","color":"dark_red"}
tellraw @s[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":":"},{"text":"[-->]","color":"green","clickEvent":{"action":"run_command","value":"/function att2:dialogs/dialogs_review/sidequest_dialogs/sq38/end2"},"hoverEvent":{"action":"show_text","value":"点击这里—回答"}}]}
