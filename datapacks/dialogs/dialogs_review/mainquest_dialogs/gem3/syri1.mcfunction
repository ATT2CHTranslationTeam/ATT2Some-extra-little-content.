...
tellraw @s[scores={LANGUAGE=2}] {"text":" °-° Syri Lorth : ","color":"green","extra":[{"text":"非常好！我们会带你去任何你想去的地方。我在不远处的大船上等你。","color":"dark_aqua"}]}
...
tellraw @s[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":":"},{"text":"[-->]","color":"green","clickEvent":{"action":"run_command","value":"/function att2:dialogs/dialogs_review/mainquest_dialogs/gem3/end"},"hoverEvent":{"action":"show_text","value":"点击这里—回答1"}}]}
