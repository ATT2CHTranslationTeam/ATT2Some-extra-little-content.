...
tellraw @s[scores={LANGUAGE=2}] {"text":"在你射爆了Golem的眼睛后，在他胡乱的攻击下，一条道路被他炸了出来..","color":"dark_green"}
...
tellraw @s[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":":"},{"text":"[动身继续探索-->]","color":"green","clickEvent":{"action":"run_command","value":"/function att2:dialogs/dialogs_review/mainquest_dialogs/gem5/end2"},"hoverEvent":{"action":"show_text","value":"点击这里—回答"}}]}
