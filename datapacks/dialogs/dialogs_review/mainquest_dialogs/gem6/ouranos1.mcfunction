...
tellraw @s[scores={LANGUAGE=2}] {"text":"你来到了Zirthion，村民们热心地接待了你并告诉你在Ouranos自由探索的方法..","color":"dark_green"}
...
tellraw @s[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":":"},{"text":"[进入Ouranos塔楼获取pelzion-->]","color":"green","clickEvent":{"action":"run_command","value":"/function att2:dialogs/dialogs_review/mainquest_dialogs/gem6/ouranos2"},"hoverEvent":{"action":"show_text","value":"点击这里—回答"}}]}
