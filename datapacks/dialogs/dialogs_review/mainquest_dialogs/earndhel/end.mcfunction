...
tellraw @s[scores={LANGUAGE=2}] {"text":"你在村长Phoebius的帮助下拿到了炎狱之章，并在Angor宫殿中找到了烈火之章，最后安放好了两个法器，与Relgon和他的军队一起，对La_Flamme_Noire进行了最终的讨伐，不幸的是，Relgon被Serile背刺了，而你知晓了这一切后，回到Earndhel与Etotsira准备下一步的计划..","color":"dark_green"}
