...
execute as @e[scores={RUNE_SUMMON_TIMER=1..}] run function att2:gameplay/invocation/action/rune_summon_effect
execute as @e[scores={DESPAWN_TIMER=1..}] run function att2:gameplay/invocation/action/despawn_effect
execute as @e[scores={RUNE_DESPAWN_TIMER=1..}] run function att2:gameplay/invocation/action/rune_despawn_effect