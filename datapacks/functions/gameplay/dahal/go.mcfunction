...
execute as @a[scores={SPELL_SLCT=261..270}] run function att2:gameplay/dahal/action/spell27/persistence
execute as @a[scores={SPELL_SLCT=271..280}] run function att2:gameplay/dahal/action/spell28/persistence
...
execute as @a[scores={SPELL_SLCT=431..440}] run function att2:gameplay/dahal/action/spell44/persistence
execute as @a[scores={SPELL_SLCT=441..450}] run function att2:gameplay/dahal/action/spell45/persistence
