...
scoreboard players add @s SPELL31_LVL 5
...
execute at @e[type=minecraft:armor_stand,tag=RuneRecyclerSpell] run function att2:gameplay/dahal/action/spell31/validate/lvl10