...
function att2:gameplay/dahal/action/spell101_cooldown
execute as @a[scores={COOLDOWN101=1,SPELL_SLCT=1001..1003}] at @s run function att2:dialogs/gameplay/dahal/spell101_ready